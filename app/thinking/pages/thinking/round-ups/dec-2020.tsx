    ...
    <>
      ...
      <BodySection sectionId={getSectionId("product-focus")}>
        ...
        <BodyText mt={LayoutConstants.margin.paragraph}>
          I <strong>love</strong> engineering, I’m passionate about UX & UI and I enjoy growth &
          product marketing, but there are certain aspects of building a business that I don’t
          enjoy. I’m inspired by the unapologetic approach Tobi has with how he spends his
          attention. This has been a huge sticking point for me in my projects.. Sales, hiring &
          raising money have never been sustained interests of mine. Keeping this in mind helps me
          battle my false belief that I should be enthused about all areas of building a business as
          an entrepreneur.
        </BodyText>
      </BodySection>
      ...
      <BodySection sectionId={getSectionId("levelling-up")}>
        ...
        <BodyText>
          Creativity generally is taking lessons learnt from one field and applying them to another
      ...
      <BodySection sectionId="customer-centricity">
        ...
        <BodyText>
          His first point was around maintaining "True Customer Obsession", that results in
          customers dissatisfaction, which will force you to continuously invent on their behalf. I
          can't think of any better ways to build the foundation of a product roadmap. Can you?
        </BodyText>
        <Quote name="Jeff Bazos">
          There are many advantages to a customer-centric approach, but here’s the big one:
          customers are always beautifully, wonderfully dissatisfied, even when they report being
        ...
        <BodyText>
          Jeff also comments on a common mistake when attempting to understand customer needs. He
          introduces the idea to "resist proxies", and how they are dangerous signs of Day 2. He
          proves an example of proxies for customers as market research and customer surveys.
        </BodyText>
        <Quote name="Jeff Bazos">
          ...market research and customer surveys can become proxies for customers – something
          that’s especially dangerous when you’re inventing and designing products. "Fifty-five
          percent of beta testers report being satisfied with this feature. That is up from 47% in
          the first survey." That’s hard to interpret and could unintentionally mislead.
        </Quote>
        <Quote name="Jeff Bazos">
          Good inventors and designers deeply understand their customer. They spend tremendous
          energy developing that intuition. They study and understand many anecdotes rather than
          only the averages you’ll find on surveys. They live with the design.
        </Quote>
      ...
      <BodySection sectionId="trust-communication">
        ...
        <BodyText mt={LayoutConstants.margin.paragraph}>
          Trust, in my opinion is an emotional luxury, that some individuals have not been fortunate
          enough to have grown up with or develop. I love how Tobi reframes the notion of developing
          trust into something which we can objectively look at, as if it were a game. Often people
          are too identified and emotionally caught up in their ability to be trusted, by describing
          it as a "trust battery" we may be more able to non-judgmentally see how we can make
      ...
      <BodySection sectionId="charging-trust">
        ...
        <BodyText mt={2}>
          Be conscious of what has happened in the past that has made it hard to trust. Building
          this awareness is usually the first step to making change.
        </BodyText>
        <Heading size="sm" mt={LayoutConstants.margin.paragraph}>
        ...
        <BodyText mt={2}>
          ...
          comedic example, related to romantic relationships provided in the book:
        </BodyText>
        <Grid
        ...
        >
          <Quote mt={LayoutConstants.margin.paragraph} name="Good communicator">
            "I love giving you a kiss, bu there's just this one tiny think: It's even nicer when
        ...
        <Quote name="Dale Carnegie" mt={LayoutConstants.margin.paragraph}>
          ...
          hurts his sense of importance, and arouses resentment. …. Any fool can criticize, condemn
          and complain—and most fools do. But it takes character and self-control to be
      ...
      <BodySection sectionId={getSectionId("inspiring-change")}>
        ...
        <Quote name="Dale Carnegie" mt={LayoutConstants.margin.paragraph}>
          When dealing with people, let us remember we are not dealing with creatures of logic. We
          are dealing with creatures of emotion, creatures bristling with prejudices and motivated
          by pride and vanity.
        </Quote>
        <BodyText>
          ...
          <List styleType="decimal">
            ...
            <ListItem>Praise the slightest improvement and praise every improvement.</ListItem>
