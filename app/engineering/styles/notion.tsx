...
const notionStyles = css`
  ...
  .notion-aside-table-of-contents .notion-table-of-contents {
    display: block;
  }
  ...
  .notion-page {
    ...
    align-items: flex-start;
    width: 100%;
    max-width: ${LayoutConstants.textMaxWidth}px;
  }
...
export const NotionStyles = () => <Global styles={notionStyles} />;
