  ...
  return (
    <>
      <PageSection>
        ...
        <PageText>
          The main purpose of this site is to document the lessons from{' '}
          <MyJourney /> over the last few years.
        </PageText>
      </PageSection>
      <PageSection>
        <PageText>
          I live to work ("workaholic"): attempting to optimize my life around
          being able to create exceptional <DigitalProducts /> that feel like
      ...
      <PageSection>
        ...
        <PageText>
          ...
          . If you're interested in helping online businesses reduce churn,
          please reach out.
        </PageText>
        <PageText>
          If you'd like to get in touch, consider{' '}
          <HomeLink href="mailto:andyasprou@hey.com?subject=Hello">
            writing an email
          </HomeLink>{' '}
          or sending a{' '}
