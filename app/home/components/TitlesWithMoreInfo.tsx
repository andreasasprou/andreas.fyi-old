...
const Content = ({ text }: { text: string }) => (
  <Text fontSize="inherit">
    ...
    <Box my={8} /> I'm in the process of migrating my personal notes to this
    digital brain dump. Come back here soon to read about my lessons and
...
export function DigitalProducts() {
  return (
    <PageTextWithHover
      hoverContent={
        <Content text="building, designing and scaling digital products" />
      }
    >
      digital products
    </PageTextWithHover>
      ...
      hoverContent={
        <List spacing={3} listStyleType="disc">
          <ListItem>
            ...
            <BoldExternalLink href="https://www.flick.tech">
              Flick.tech
            </BoldExternalLink>{' '}
            to $2M ARR in a couple of years whilst graduating computer science
            at Imperial College London in the top 3 of the cohort.
          </ListItem>
          <ListItem>
            Co-founding{' '}
            <BoldExternalLink href="https://www.dweet.com">
              Dweet.com
            </BoldExternalLink>{' '}
            - the first business that is successfully bringing the world of
            freelance work to the fashion & retail industries.
          </ListItem>
          <ListItem>
            Founding & solo-developing multiple other side-projects{' '}
            <BoldExternalLink href="https://combox.app">
              Combox
            </BoldExternalLink>{' '}
            &{' '}
